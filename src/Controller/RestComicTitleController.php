...
#[Routing\Route(
    path: '/api/rest/comics/{comicCode}/titles',
    name: 'rest_comic_title_'
)]
class RestComicTitleController extends AbstractController
{
    ...
    public function list(
        ...
        $result = $this->comicTitleRepository->findByCustom($criteria, $orderBy, $limit, $offset);

        $headers = [];
        $headers['X-Total-Count'] = $this->comicTitleRepository->countCustom($criteria);
    ...
    public function post(
        ...
        $headers = [];
        $headers['Location'] = $this->generateUrl('rest_comic_title_get', [
