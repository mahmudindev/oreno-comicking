...
#[Routing\Route(
    path: '/api/rest/category-types',
    name: 'rest_categorytype_'
)]
class RestCategoryKindController extends AbstractController
{
    ...
    public function list(
        ...
        $result = $this->categoryKindRepository->findByCustom($criteria, $orderBy, $limit, $offset);

        $headers = [];
        $headers['X-Total-Count'] = $this->categoryKindRepository->countCustom($criteria);
        $headers['X-Pagination-Limit'] = $limit;

        $response = $this->json($result, Response::HTTP_OK, $headers, ['groups' => ['categoryType']]);
    ...
    public function post(
        ...
        $headers = [];
        $headers['Location'] = $this->generateUrl('rest_categorytype_get', ['code' => $result->getCode()]);

        return $this->json($result, Response::HTTP_CREATED, $headers, ['groups' => ['categoryType']]);
    }
    ...
    public function get(
        ...
        if (!$result) throw new NotFoundHttpException('Category Type not found.');

        $response = $this->json($result, Response::HTTP_OK, [], ['groups' => ['categoryType']]);
    ...
    public function patch(
        ...
        return $this->json($result, Response::HTTP_OK, $headers, ['groups' => ['categoryType']]);
    }
