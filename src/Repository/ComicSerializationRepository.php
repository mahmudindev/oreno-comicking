...
/**
 * @extends ServiceEntityRepository<ComicSerialization>
 */
class ComicSerializationRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, ComicSerialization::class);
    }
    ...
    public function findByCustom(
        ...
        $query = $this->createQueryBuilder('c')
            ...
            ->leftJoin('c.magazine', 'cm')->addSelect('cm');
