...
/**
 * @extends ServiceEntityRepository<ComicRelationKind>
 */
class ComicRelationKindRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, ComicRelationKind::class);
    }
