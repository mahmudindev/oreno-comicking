...
/**
 * @extends ServiceEntityRepository<ComicCharacter>
 */
class ComicCharacterRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, ComicCharacter::class);
    }
