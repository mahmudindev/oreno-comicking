...
class ComicRelationRepository extends ServiceEntityRepository
{
    ...
    public function findByCustom(
        ...
        $query = $this->createQueryBuilder('c')
            ...
            ->leftJoin('c.child', 'cc')->addSelect('cc');
        ...
        foreach ($criteria as $key => $val) {
            ...
            switch ($key) {
                ...
                case 'childCodes':
                    ...
                    if ($c == 1) {
                        $query->andWhere('cc.code = :childCode');
                        $query->setParameter('childCode', $val[0]);
                        break;
                    }
                    $query->andWhere('cc.code IN (:childCodes)');
                    $query->setParameter('childCodes', $val);
                    break;
            }
        }
