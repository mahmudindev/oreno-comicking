 ...
 */
final class Version20251109080637 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Replace instead because f*ck duplicate drop statement, unknown error, etc.';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE comic_author (
              ...
              INDEX IDX_B478E53BDD842E46 (position_id),
              INDEX IDX_B478E53B217BBB47 (person_id),
              UNIQUE INDEX UNIQ_B478E53BD663094ADD842E46217BBB47 (comic_id, position_id, person_id),
              PRIMARY KEY(id)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE comic_author_position (
              id BIGINT AUTO_INCREMENT NOT NULL,
              created_at DATETIME NOT NULL COMMENT '(DC2Type:datetimetz_immutable)',
              updated_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetimetz_immutable)',
              code VARCHAR(32) NOT NULL,
              name VARCHAR(32) NOT NULL,
              UNIQUE INDEX UNIQ_51641BB077153098 (code),
              PRIMARY KEY(id)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE comic_chapter_title (
              id BIGINT AUTO_INCREMENT NOT NULL,
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE comic_cover (
              ...
              INDEX IDX_EC795EC93DA5256D (image_id),
              UNIQUE INDEX UNIQ_EC795EC9D663094A3DA5256D (comic_id, image_id),
              PRIMARY KEY(id)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE comic_external (
              id BIGINT AUTO_INCREMENT NOT NULL,
              comic_id BIGINT NOT NULL,
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE comic_relation_type (
              id BIGINT AUTO_INCREMENT NOT NULL,
              created_at DATETIME NOT NULL COMMENT '(DC2Type:datetimetz_immutable)',
              updated_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetimetz_immutable)',
              code VARCHAR(32) NOT NULL,
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE comic_serialization (
              id BIGINT AUTO_INCREMENT NOT NULL,
              comic_id BIGINT NOT NULL,
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE comic_volume_cover (
              id BIGINT AUTO_INCREMENT NOT NULL,
              ...
              INDEX IDX_5816521C3DA5256D (image_id),
              UNIQUE INDEX UNIQ_5816521C8FD80EEA3DA5256D (volume_id, image_id),
              PRIMARY KEY(id)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE comic_volume_title (
              id BIGINT AUTO_INCREMENT NOT NULL,
              volume_id BIGINT NOT NULL,
              language_id BIGINT NOT NULL,
              created_at DATETIME NOT NULL COMMENT '(DC2Type:datetimetz_immutable)',
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE image (
              ...
              UNIQUE INDEX UNIQ_C53D045FC288C859 (ulid),
              INDEX IDX_C53D045FADA40271 (link_id),
              PRIMARY KEY(id)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE website (
              ...
              created_at DATETIME NOT NULL COMMENT '(DC2Type:datetimetz_immutable)',
              updated_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetimetz_immutable)',
              host VARCHAR(64) NOT NULL COLLATE `utf8mb4_bin`,
              name VARCHAR(64) NOT NULL,
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE
              comic_author
            ADD
              CONSTRAINT FK_B478E53BDD842E46 FOREIGN KEY (position_id) REFERENCES comic_author_position (id)
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE
              comic_author
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE
              comic_cover
            ADD
              CONSTRAINT FK_EC795EC93DA5256D FOREIGN KEY (image_id) REFERENCES image (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE
              comic_external
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE
              comic_volume_cover
            ADD
              CONSTRAINT FK_5816521C3DA5256D FOREIGN KEY (image_id) REFERENCES image (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE
              comic_volume_title
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE
              image
            ADD
              CONSTRAINT FK_C53D045FADA40271 FOREIGN KEY (link_id) REFERENCES link (id) ON DELETE CASCADE
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE
              link
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comic_author DROP FOREIGN KEY FK_B478E53BDD842E46');
        ...
        $this->addSql('ALTER TABLE comic_cover DROP FOREIGN KEY FK_EC795EC93DA5256D');
        ...
        $this->addSql('ALTER TABLE comic_volume_cover DROP FOREIGN KEY FK_5816521C3DA5256D');
        ...
        $this->addSql('ALTER TABLE image DROP FOREIGN KEY FK_C53D045FADA40271');
        ...
        $this->addSql('DROP TABLE comic_author_position');
